...
<body>
	...
	<section id ="container">
			...
			<div class="container-fluid">
					...
					<c:forEach items="${secondCateList}" var="secondCateList"> <!--1차카테고리를 누르면 그 화면에 2차 카테고리 리스트를 출력 -->
						<a class="btn btn-primary btn-learn" href="/shop/list?c=${secondCateList.cateCode}&l=1">${secondCateList.cateName}</a>
					</c:forEach>
						 	<h2>Our goods</h2>			
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-6 animate-box text-center">
						<a href="/shop/view?n=${list.gdsNum}" class="work-img">
					...
					<div class="col-md-6 animate-box text-center">
						...
						<a href="/shop/view?n=${recommendGoods.gdsNum}" class="work-img" style="background-image: url();">
